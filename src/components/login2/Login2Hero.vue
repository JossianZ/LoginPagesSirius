<template>
  <div class="login2-hero h-full flex flex-col relative">
    ...
    <div class="flex-1 flex items-center justify-center" @mousemove="handleMouseMove" @mouseleave="resetPosition">
      <div class="flex items-center gap-4 transition-transform duration-500 ease-out"
        ...
        <div class="flex flex-col items-center animate-float transition-all duration-300"
          ...
          <div
            :class="['w-16 h-16 rounded-xl border-2 flex items-center justify-center transition-all duration-300 hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/50 cursor-pointer',
              settingsStore.theme === 'dark' ? 'bg-slate-800/80 border-slate-700' : 'bg-slate-100 border-slate-300']">
            <svg :class="['w-7 h-7', settingsStore.theme === 'dark' ? 'text-zinc-400' : 'text-zinc-500']" fill="none"
          ...
          <span :class="['text-xs mt-1.5', settingsStore.theme === 'dark' ? 'text-zinc-500' : 'text-zinc-600']">{{
        ...
        <div class="relative transition-all duration-300"
          ...
          <svg class="w-6 h-6 text-purple-500 animate-arrow-forward" fill="none" stroke="currentColor"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14 5l7 7m0 0l-7 7m7-7H3" />
          </svg>
          <!-- Animated dot -->
          <div
            class="absolute top-1/2 -translate-y-1/2 left-0 w-1 h-1 rounded-full bg-purple-500 animate-dot-travel shadow-[0_0_6px_rgba(168,85,247,0.8)]">
          </div>
        </div>

        <!-- Lobster Lead Box -->
        <div class="flex flex-col items-center animate-float group transition-all duration-300"
          style="animation-delay: 0.2s;" @mouseenter="handleLogoHover"
          ...
          <div
            ...
            <!-- Shine effect -->
            <div
              class="absolute inset-0 -translate-x-full animate-shine bg-gradient-to-r from-transparent via-white/30 to-transparent">
            </div>
            ...
            <img :src="lobsterSmallLogo" alt="Lobster Lead"
              :class="['w-12 h-12 object-contain relative z-10', { 'animate-shake': isShaking }]" />
          </div>
          <span
        ...
        <div class="relative transition-all duration-300"
          ...
          <svg class="w-6 h-6 text-red-500 animate-arrow-forward" style="animation-delay: 0.1s;" fill="none"
            stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14 5l7 7m0 0l-7 7m7-7H3" />
          </svg>
          <!-- Animated dot -->
          <div
            class="absolute top-1/2 -translate-y-1/2 left-0 w-1 h-1 rounded-full bg-red-500 animate-dot-travel shadow-[0_0_6px_rgba(239,68,68,0.8)]"
        ...
        <div class="flex flex-col gap-1.5 transition-all duration-300"
          ...
          <div
            ...
            <div
              class="absolute rounded-lg opacity-0 group-hover:opacity-100 group-hover:animate-pulse-border pointer-events-none border-2 border-purple-500"
              style="inset: -1px;"></div>
            <div
              class="w-6 h-6 rounded-lg bg-purple-500/10 flex items-center justify-center group-hover:animate-pulse-hover">
          ...
          <div
            ...
            <!-- Animated border on hover -->
            <div
              class="absolute rounded-lg opacity-0 group-hover:opacity-100 group-hover:animate-pulse-border pointer-events-none border-2 border-red-500"
              style="inset: -1px;"></div>
            <div
              class="w-6 h-6 rounded-lg bg-red-500/10 flex items-center justify-center group-hover:animate-pulse-hover">
          ...
          <div
            ...
            <!-- Animated border on hover -->
            <div
              class="absolute rounded-lg opacity-0 group-hover:opacity-100 group-hover:animate-pulse-border pointer-events-none border-2 border-green-500"
              style="inset: -1px;"></div>
            <div
              class="w-6 h-6 rounded-lg bg-green-500/10 flex items-center justify-center group-hover:animate-pulse-hover">
