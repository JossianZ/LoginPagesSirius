<template>
  <div
    class="login1-hero relative w-full h-full min-h-screen bg-[#1a2332] overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <svg class="absolute w-full h-full opacity-25" viewBox="0 0 1200 800" preserveAspectRatio="none">
        ...
        <path d="M0,240 Q300,200 600,280 Q900,360 1200,320" 
              fill="none" 
              stroke="rgba(100, 150, 200, 0.6)" 
              stroke-width="1.5" />
        
        <!-- İkinci çizgi - birincinin tersi, üstünden geçiyor -->
        <path d="M0,320 Q300,360 600,280 Q900,200 1200,240" 
              fill="none" 
              stroke="rgba(100, 150, 200, 0.5)" 
              stroke-width="1.5" />
        
        <!-- Alt çizgi - geniş yumuşak dalga -->
        <path d="M0,580 Q300,520 600,560 Q900,600 1200,540" 
              fill="none" 
    ...
    <div class="relative z-10 h-full flex flex-col p-8 lg:p-12 xl:p-16">
      ...
      <div class="flex-1 flex flex-col justify-center max-w-2xl">
        <TransitionGroup name="fade">
          ...
          <div v-if="currentSlide === 0" key="slide-0" class="absolute max-w-2xl">
...
Platformumuz, sürücü atamalarından dijital dokümantasyona kadar karmaşık lojistik iş akışlarını otomatikleştirerek idari iş yükünü %65, insan hatasını ise %92 oranında azaltıyor.
          ...
          <div v-if="currentSlide === 1" key="slide-1" class="absolute max-w-2xl">
            <div class="inline-flex items-center gap-2 mb-8">
            ...
            <p class="text-gray-400 text-lg leading-relaxed mb-12">
              Yapay zeka destekli rota planlama sistemi, trafik verilerini analiz ederek en verimli güzergahları belirler ve yakıt maliyetlerini
          ...
          <div v-if="currentSlide === 2" key="slide-2" class="absolute max-w-2xl">
            <div class="inline-flex items-center gap-2 mb-8">
            ...
            <p class="text-gray-400 text-lg leading-relaxed mb-12">
              Tüm kargolarınızı anlık olarak takip edin. IoT sensörleri ve GPS teknolojisi ile teslimat süreçlerini şeffaflaştırın ve müşteri memnuniyetini
          ...
          <div v-if="currentSlide === 3" key="slide-3" class="absolute max-w-2xl">
            <div class="inline-flex items-center gap-2 mb-8">
            ...
            <p class="text-gray-400 text-lg leading-relaxed mb-12">
              Otonom depo yönetim sistemi, stok seviyelerini optimize eder, ürün yerleşimini iyileştirir ve operasyonel verimliliği
